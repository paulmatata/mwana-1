...
<div class="card" style="max-width:560px;">
    <form method="POST" action="{{ route('principal.notices.store') }}">
        @csrf
        ...
        <div class="target-choice">
            <label><input type="radio" name="target" value="school" onchange="toggleTarget()" checked> Whole school</label>
            <label><input type="radio" name="target" value="class" onchange="toggleTarget()"> One class</label>
            <label><input type="radio" name="target" value="student" onchange="toggleTarget()"> One student</label>
        </div>

        <div id="class-picker" style="display:none;">
        ...
        <div style="display:flex; gap:12px; margin-top:8px;">
            ...
            <a href="{{ route('principal.notices.index') }}" class="btn secondary">Cancel</a>
        </div>
    </form>
</div>
